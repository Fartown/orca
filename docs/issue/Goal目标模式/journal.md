...
| 方案         | [Goal 守卫监工与唤醒兜底修订方案](solutions/Goal守卫监工与唤醒兜底修订方案.md) | reviewing | 第 2 版，五项默认值已确认（C15）；等用户确认方案后按 WP-G1～WP-G5 实施 |
| 方案评审     | [修订方案评审报告](solutions/Goal守卫监工与唤醒兜底修订方案.review.md) | completed | 2026-09-23 Claude 与 TRAE CLI 双路独立评审：2 条 P0、21 条 P1；逐条处置已附在报告末节 |
...
| 测试用例     | [功能测试](tests/cases/Goal功能测试.md)                                | needs-update | TC-344～TC-361 覆盖验收文档、异步草稿、文件查看与 SSH；REQ-103、106、112～114、121、124～126 的行为变化待修订方案评审后补写 |
