import type { AiVaultOriginalPaneSessionReference } from './ai-vault-original-pane'
...
function sessionPromptCandidates(session: AiVaultOriginalPaneSessionReference): string[] {
