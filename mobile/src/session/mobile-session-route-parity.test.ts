...
const HEAD_NESTED_FUNCTION_SHA256 =
  '6ea3614809f664bcc4ae097b3f391271779887b0da3ca9450d1a1763a1aceca2'
...
const HEAD_RUNTIME_STRING_SHA256 =
  'a8929ce35c20ffc28307f44a1112b55a4e6b4f4b0607571a9ba1b0841ae8e5f1'
...
describe('mobile session route extraction parity', () => {
  ...
  it('preserves runtime strings, styles, and the expanded JSX tree', () => {
    ...
    expect(strings).toHaveLength(544)
