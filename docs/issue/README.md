...
| --- | --- | --- | --- | --- | --- | --- |
| [集成分支自动出包](集成分支自动出包/journal.md) | 同源发布 fork 内测包，并提供桌面更新清单和 Android 应用内更新 | testing | [集成分支自动出包](集成分支自动出包/requirements/集成分支自动出包.md) | [macOS自动更新签名修复方案](集成分支自动出包/solutions/macOS自动更新签名修复方案.md) | [自动出包](集成分支自动出包/tests/cases/自动出包.md) | 2026-09-12 |
