...
export const RPC_PARAMS_BY_METHOD = {
  ...
  'conversations.bindIssue': ConversationsBindIssueParams,
  'conversations.delete': ConversationsDeleteParams,
  'conversations.get': ConversationsGetParams,
  'conversations.list': ConversationsListParams,
  'conversations.prepareDelete': ConversationsPrepareDeleteParams,
  'conversations.prepareLaunch': ConversationsPrepareLaunchParams,
  'conversations.prepareRetry': ConversationsPrepareRetryParams,
  'conversations.recordLaunchFailure': ConversationsRecordLaunchFailureParams,
  'conversations.update': ConversationsUpdateParams,
  ...
  'issues.archive': IssuesLifecycleParams,
  'issues.create': IssuesCreateParams,
  'issues.delete': IssuesDeleteParams,
  'issues.get': IssuesGetParams,
  'issues.list': IssuesListParams,
  'issues.listRounds': IssuesListRoundsParams,
  'issues.markRead': IssuesMarkReadParams,
  'issues.prepareDelete': IssuesPrepareDeleteParams,
  'issues.reopen': IssuesLifecycleParams,
